...
const musicData = [
  {
    ...
    lyrics: "./assets/lyrics/1. Kejora.lrc"
  },
  {
    ...
    lyrics: "./assets/lyrics/1. Zapin Melayu.lrc"
  },
  {
  ...
  },
  {
    ...
    lyrics: "./assets/lyrics/Purnama.lrc"
  },
  {
  ...
  },
  {
    ...
    lyrics: "./assets/lyrics/1. Ada Cerita.lrc"
  },
  {
    ...
    lyrics: "./assets/lyrics/Tirani.lrc"
  },
  {
  ...
  },
  {
    ...
    lyrics: "./assets/lyrics/1. Bawa Aku Ke Penghulu.lrc"
  },
  {
    ...
    lyrics: "./assets/lyrics/1. Takdir Cinta.lrc"
  },
  {
    ...
    lyrics: "./assets/lyrics/1. Lentera.lrc"
  },
  {
    ...
    lyrics: "./assets/lyrics/1. Sekali Seumur Hidup.lrc"
  },
  {
    ...
    lyrics: "./assets/lyrics/1. Insan Biasa.lrc"
  ...
  },
  {
    ...
    lyrics: "./assets/lyrics/1. Di Arsy-Mu.lrc"
  ...
  },
  {
    ...
    lyrics: "./assets/lyrics/1. Terkesan.lrc"
  },
  {
    ...
    lyrics: "./assets/lyrics/1. Menyerah.lrc"
  ...
  },
  {
    ...
    lyrics: "./assets/lyrics/1. Angin.lrc"
  ...
  },
  {
    ...
    lyrics: "./assets/lyrics/1. Mencintaimu Karena Allah.lrc"
  },
  {
  ...
  },
  {
    ...
    lyrics: "./assets/lyrics/1. Bukan Karena Tak Cinta (Dangdut Version).lrc"
  ...
  },
  {
    ...
    lyrics: "./assets/lyrics/1. Udang Di Balik Batu.lrc"
  ...
  },
  {
    ...
    lyrics: "./assets/lyrics/1. Satu Satunya Permaisurimu.lrc"
  ...
  },
  {
    ...
    lyrics: "./assets/lyrics/1. Dilema.lrc"
  },
  {
    ...
    lyrics: "./assets/lyrics/adayangpunya.lrc"
  },
];
...
function loadLyrics(url) {
  if (!url) {
    lyricElement.textContent = 'No lyrics available';
    lyrics = [];
    return;
  }
  lyricElement.textContent = 'Loading lyrics...';
  fetch(url)
    .then(res => res.text())
    .then(parseLRC)
    .catch(() => lyricElement.textContent = 'Lyrics failed to load');
}
...
audioSource.addEventListener('timeupdate', updateLyrics);
...
playerSkipNextBtn.addEventListener("click", () => {
  lastPlayedMusic = currentMusic;
  isShuffled ? shuffleMusic() : currentMusic = (currentMusic + 1) % musicData.length;
  changePlayerInfo();
  changePlaylistItem();
});

playerSkipPrevBtn.addEventListener("click", () => {
  lastPlayedMusic = currentMusic;
  isShuffled ? shuffleMusic() : currentMusic = (currentMusic - 1 + musicData.length) % musicData.length;
  changePlayerInfo();
  changePlaylistItem();
});

const shuffleMusic = () => currentMusic = Math.floor(Math.random() * musicData.length);
...
function changePlayerInfo() {
  ...
  loadLyrics(musicData[currentMusic].lyrics);
